...
* flex와 grid의 두드러진 차이점은 flex는 1차원적 레이아웃, grid는 2차원적 레이아웃의 표현에 최적회된 속성이라는 것인데, 두 속성들은 작은 구성 요소가 2차원이 될 수 있고, 큰 레이아웃이 1차원의 레이아웃으로 더 잘 표현될 수 있기 때문에 각각의 이점을 활용하여 구성하기!   
