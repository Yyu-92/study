...
* 다양한 디바이스의 크기에 맞춰 디바이스 별로 반응형 뷰를 제공한다.
* 작은 화면에서 효율적으로 웹 콘텐츠를 보여주는데 최적화
* 효율적인 메모리 사용, 가볍고 빠른 속도
* pc와 mobile의 연동성
* 다양한 부가적 기능
    1. 웨일 - 확장 프로그램 / 한글 뷰어 탑재 / 분할 화면 기능과 같은 편리한 화면 구성 / 사이드 바
    2. 엣지 - mocrosoft365 애플리케이션과의 연동
    3. 크롬 - 확장 프로그램 / 고급 기능 및 개발자 도구
